...
async def autoshopify_gate_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "    ⚡ 𝐀𝐮𝐭𝐨 𝐒𝐡𝐨𝐩𝐢𝐟𝐲\n"
        "✦━━━━━━━━━━━━━━✦\n\n"
        "<code>/sp    - Auto Shopify Checker</code>\n"
        "<code>Example:</code>\n"
        "<code>/sp 1234567890123456|12|2026|123</code>\n\n"
        "<code>/msp   - Mass Auto Shopify Checker</code>\n"
        "<code>Example:</code>\n"
        "<code>/msp 1234567890123456|12|2026|123</code>\n\n"
        "<code>/seturl &lt;shopify site&gt; - Set your custom Shopify site</code>\n"
        "<code>Example:</code>\n"
        "<code>/seturl https://yourshopify.com</code>\n\n"
